...
import (
	...
	"nexcoreproxy-panel/util/common"
	"nexcoreproxy-panel/web/controller"
	"nexcoreproxy-panel/web/job"
	"nexcoreproxy-panel/web/locale"
	"nexcoreproxy-panel/web/middleware"
	"nexcoreproxy-panel/web/network"
	"nexcoreproxy-panel/web/service"
	"nexcoreproxy-panel/web/websocket"
